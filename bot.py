...
# ===============================
# 🎨 Стили аватарок (в нужном порядке)
# ===============================
STYLES = {
...
async def send_welcome(message: Message):
    await message.answer(
        "📸 Привет! Отправь мне своё фото — и я создам стильную аватарку!\n\n"
        "Доступные стили:\n"
        "✨ Новогодний\n"
        "💎 Премиум\n"
        "📸 Фотостудия\n"
...
async def handle_photo(message: Message):
    ...
    # Скачиваем самую большую версию фото
    ...
    try:
        ...
        # Удаляем фото сразу после обработки (для конфиденциальности)
